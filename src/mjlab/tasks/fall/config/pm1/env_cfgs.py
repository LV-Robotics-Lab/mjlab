...
def pm1_flat_falling_env_cfg(
  ...
  *,
  ...
  #   "LINK_ELBOW_END_R",
  # )
  # cfg.terminations["forbidden_body_contact_force"].params["force_threshold"] = 2000.0
  ...
  if enable_amp_env:
    assert cfg.amp is not None, "make_fall_env_cfg must define cfg.amp when enable_amp_env=True"
    cfg.amp.motion_file = [
